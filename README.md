...
This is a sample template for dmpmiddleware.ca.unileversolutions - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name dmpmiddleware.ca.unileversolutions \
...
```bash
sam logs -n HelloWorldFunction --stack-name dmpmiddleware.ca.unileversolutions --tail
```
...
```bash
aws cloudformation delete-stack --stack-name dmpmiddleware.ca.unileversolutions
```
